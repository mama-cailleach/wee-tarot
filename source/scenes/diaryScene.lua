...
function DiaryScene:init()
    ...
    self.lockSprite:addState("move", 1, 11, {tickStep = 4, yoyo = false, loop = false, onAnimationEndEvent = function() self.lockSprite:changeState("pause") end})
    self.lockSprite:addState("pause", 12, 12, {tickStep = 48, yoyo = false, loop = false, onAnimationEndEvent = function() self.lockSprite:changeState("move") end})
    self.lockSprite:moveTo(200, 120)
    self.lockSprite:setZIndex(10)
    self.lockSprite:add()
